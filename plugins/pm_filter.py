...
from info import IS_PREMIUM, PICS, TUTORIAL, SHORTLINK_API, SHORTLINK_URL, OWNER_USERNAME, UPI_NAME, UPI_ID, ONE_WEEK_PRICE, ONE_MONTH_PRICE, THREE_MONTHS_PRICE, SIX_MONTHS_PRICE, ONE_YEAR_PRICE, SECOND_FILES_DATABASE_URL, ADMINS, URL, MAX_BTN, BIN_CHANNEL, IS_STREAM, DELETE_TIME, FILMS_LINK, LOG_CHANNEL, SUPPORT_GROUP, SUPPORT_LINK, UPDATES_LINK, LANGUAGES, QUALITY
